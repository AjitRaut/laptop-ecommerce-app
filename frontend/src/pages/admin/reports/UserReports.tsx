...
const UserReports: React.FC = () => {
  ...
  const { data, isLoading, isFetching } = useGetUserReportSummaryQuery(filters);
  const [exportReport] = useLazyExportUserReportQuery();
  ...
  const userTypeData = [
    { name: 'Customers', value: data?.summary.customers || 0 },
    { name: 'Vendors', value: data?.summary.vendors || 0 },
    { name: 'Admins', value: data?.summary.admins || 0 },
  ];
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">User registration and activity analytics</p>
        </div>
        <ExportButton
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl shadow-lg p-6"
        >
          <h2 className="text-xl font-bold text-gray-900 mb-6">User Status</h2>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={[
              { name: 'Active', value: data?.summary.active_users || 0 },
              { name: 'Inactive', value: data?.summary.inactive_users || 0 },
            ]}>
