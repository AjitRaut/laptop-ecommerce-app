  ...
  tempDiv.innerHTML = `
    <div style="max-width: 800px; margin: 0 auto; padding: 40px;">
      <div style="text-align: center; margin-bottom: 40px;">
        <h1 style="color: #1e40af; font-size: 32px; margin: 0;">LaptopShop</h1>
      ...
      <div style="margin-top: 60px; text-align: center; color: #6b7280; font-size: 14px;">
        <p>Thank you for shopping with LaptopShop!</p>
        <p>For any queries, please contact us at support@laptopshop.com</p>
      </div>
    </div>
  `;
