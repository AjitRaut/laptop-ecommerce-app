      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-4">
              <div className="bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg p-2 mr-3">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20 6H4c-1.11 0-2 .89-2 2v8c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm0 10H4V8h16v8z"/>
                </svg>
              </div>
              <span className="text-xl font-bold">LaptopWorld</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-xs">
              Your trusted destination for premium laptops and accessories. Quality products, competitive prices, and exceptional service.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row md:items-center md:justify-between">
          <div className="text-sm text-gray-400">
            <p>&copy; {new Date().getFullYear()} LaptopWorld. All rights reserved.</p>
          </div>
          <div className="mt-4 md:mt-0 flex items-center space-x-6">
            <div className="flex items-center space-x-2">
              ...
              <div className="flex space-x-2">
                ...
                <div className="w-8 h-5 bg-gray-700 rounded text-white text-xs flex items-center justify-center">
                  UPI
                </div>
              </div>
            </div>
